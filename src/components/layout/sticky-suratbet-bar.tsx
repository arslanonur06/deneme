...
function StickySuratbetBarInner({ href }: { href: string }) {
  return (
...
/**
 * Mobil ve masaüstünde sürekli erişim için alt sabit çubuk (tümü Suratbet ortak URL).
 */
export function StickySuratbetBar() {
  const href = usePartnerAffiliateHref();
  return <StickySuratbetBarInner href={href} />;
}

export function StickySuratbetBarFallback() {
  return <StickySuratbetBarInner href={siteConfig.partner.affiliateUrl} />;
}
